...
const getAlltutors = async (req: Request, res: Response) => {
  ...
  const searchTutor= async (req: Request, res: Response) => {
      try {          
          ...
          console.log(tutorDetails,"ithanu tutorDtails")
...
const unlistTutor = async (req: Request, res: Response) => {
  try {
      ...
      return res.status(200).json({ message: "Tutor has been successfully unlisted" });
  } catch (error) {
  ...
  const relistTutor = async (req: Request, res: Response) => {
    try {
        ...
        return res.status(200).json({ message: "Tutor has been successfully relisted" });
    } catch (error) {
