...
function Admincourselist() {
  ...
  // Filter courseDetails based on search query
  const filteredCourseDetails = courseDetails.filter(course =>
      ...
      <div className="px-3 bg-white">
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          <input
            ...
            className="border border-gray-300 p-3 mb-5 ml-2 mt-2"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
          />
          <table className="w-full text-sm text-left text-gray-700 dark:text-gray-400">
            <thead className="text-s text-blue-800 uppercase dark:text-gray-400">
              <tr>
            ...
            <tbody>
              {filteredCourseDetails.map((course, index) => (
